...
<html lang="en">
    ...
    <?php include_once ('controller/c_register_method_budget.php'); ?>  
    <head>
        ...
        if (isset($_POST['name']) && isset($_POST['description'])) {
            ...
            if (isset($_POST['submittype']) && $_POST['submittype'] == "REGISTER") {
                $view_result = submit_methodofreceivingfunding($_POST['name'], $_POST['description']);
            } else {
                $view_result = submitupdate_methodofreceivingfunding($_POST['name'], $_POST['description'], $_POST['id']);
            }
        } else if (isset($_POST['deactivate'])) {
            $view_result = delete_methodbudget(($_POST['deactivate']));
        }
        ?>
    </head>
    <!-- END HEAD -->
            ...
            <div class="page-wrapper-row full-height">
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                                                                ...
                                                                if (isset($_POST['update'])) {
                                                                    ...
                                                                    if ($query_result != FALSE) {
                                                                        foreach ($query_result as $arr_result) {
                                                                            $id = $arr_result['registration_methodID'];
                                                                        ...
                                                                        <table class="table table-bordered table-striped table-hover" id="sample_2">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                if ($query_result != FALSE) {
                                                                                    ...
                                                                                    <td align="center"><button name="deactivate" value="' . $arr_result['registration_methodID'] . '" class="btn btn-danger btn-md"/><span class="fa fa-remove"></span></td>
                                                                                    <td align="center"><button name="update" value="' . $arr_result['registration_methodID'] . '" class="btn btn-warning btn-md"/><span class="fa fa-pencil"></span></td>'
                                                                                        . '      </tr>';
                                                                                    }
                                                                                }
                                                                                ?>
                        ...
                        <div style="display: none;" class="btn btn-default mt-sweetalert" data-title="Budget Method Update" data-message="The information you have entered has been successfully saved" data-allow-outside-click="true" data-confirm-button-class="btn-default" id ="update">Default Alert</div>
