...
<html lang="en">
    ...
    <?php include_once ('controller/c_collection_upload_eventdataregion.php'); ?>  
    <head>
        <?php
        ...
        if (isset($_FILES['fileupload']) ) {
            ...
            if ($_FILES['fileupload']['name'] == "EVENT_DATA_PER_REGION.csv"){$view_result = submit_eventdata_region($_SESSION['project'], $imgData, $_SESSION['userid']);
            }
                                                    ...
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-green-steel uppercase bold">UPLOAD EVENT DATA PER REGION</span>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row list-separated">
                                                                <form class="col-md-10" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Municipality" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail">Barangay</label>
                                                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Barangay" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail">No. of Deaths</label>
                                                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="No. of Deaths" required>
                                                                    </div>
