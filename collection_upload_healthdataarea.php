...
<html lang="en">
    ...
    <?php include_once ('controller/c_collection_upload_healthdataarea.php'); ?>  
    <head>
        <?php
       ...
       if (isset($_FILES['fileupload']) ) {
            ...
            if ($_FILES['fileupload']['name'] == "HEALTH_DATA_PER_AREA.csv"){$view_result = submit_healthdata_area($_SESSION['project'], $imgData, $_SESSION['userid']);
            }
