...
<html lang="en">
    ...
    <?php include_once ('controller/c_register_budget_type.php'); ?>   
    ...
    <head>
        ...
        if (isset($_POST['name']) && isset($_POST['description'])) {
            ...
            if (isset($_POST['submittype']) && $_POST['submittype'] == "REGISTER") {
                $view_result = submit_budgetcategory($_POST['name'], $_POST['description']);
            } else {
                $view_result = submitupdate_budgettype($_POST['name'], $_POST['description'], $_POST['id']);
            }
        } else if (isset($_POST['deactivate'])) {
            $view_result = delete_budgettype(($_POST['deactivate']));
        }
        ?>
    </head>
    <!-- END HEAD -->
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="row list-separated">
                                                                ...
                                                                if (isset($_POST['update'])) {
                                                                    ...
                                                                    $query_result = getupdate_budgettype($_POST['update']);
                                                                        ...
                                                                        <table class="table table-bordered table-striped table-hover" id="sample_2">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                if ($query_result != FALSE) {
                                                                                    ...
                                                                                    <td align="center"><button name="deactivate" value="' . $arr_result['budget_categoryID'] . '" class="btn btn-danger btn-md"/><span class="fa fa-remove"></span></td>
                                                                                    <td align="center"><button name="update" value="' . $arr_result['budget_categoryID'] . '" class="btn btn-warning btn-md"/><span class="fa fa-pencil"></span></td>'
                                                                                        . '      </tr>';
                                                                                    }
                                                                                }
                                                                                ?>
