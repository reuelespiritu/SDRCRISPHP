            ...
            <div class="page-wrapper-middle">
                ...
                <div class="page-container">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            if ($query_result != FALSE) {
                                                                                foreach ($query_result as $arr_result) {
                                                                                    ...
                                                                                    <td align="center"><button name="deactivate" value="' . $arr_result['fundingorganization_typeID'] . '" class="btn btn-danger btn-md"/><span class="fa fa-remove"></span></td>
                                                                                    <td align="center"><button name="update" value="' . $arr_result['fundingorganization_typeID'] . '" class="btn btn-warning btn-md"/><span class="fa fa-pencil"></span></td>'
                                                                                    . '      </tr>';
                                                                                }
                                                                            }
                                                                            ?>
                    ...
                    <!-- END CONTENT BODY -->
                        ...
                        <div style="display: none;" class="btn btn-default mt-sweetalert" data-title="Funding Organization Type Registered" data-message="The information you have entered has been successfully saved" data-allow-outside-click="true" data-confirm-button-class="btn-default" id ="confirm">Default Alert</div>
                        <div style="display: none;" class="btn btn-default mt-sweetalert" data-title="Funding Organization Type Deleted" data-message="The information you have entered has been successfully saved" data-allow-outside-click="true" data-confirm-button-class="btn-default" id ="delete">Default Alert</div>
                        <div style="display: none;" class="btn btn-default mt-sweetalert" data-title="Funding Organization Type Updated" data-message="The information you have entered has been successfully saved" data-allow-outside-click="true" data-confirm-button-class="btn-default" id ="update">Default Alert</div>
