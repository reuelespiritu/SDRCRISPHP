...
ob_start();
    ...
    <meta charset="utf-8" />
        ...
        <!----Select 2--->
        <link href="assets/pages/css/select2.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="stylesheet" href="assets/layouts/layout3/css/layout.css" type="text/css">
        
        <!-- JQuery DataTable Css -->
        <link href="assets/layouts/layout3/css/dataTables.bootstrap.css" rel="stylesheet" type="text/css"/>
